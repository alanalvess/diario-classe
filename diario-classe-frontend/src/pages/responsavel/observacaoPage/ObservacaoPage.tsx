                    ...
                    >
                      ...
                      <TableCell>
                        {Object.entries(CategoriasAgrupadas).map(([grupo, categorias]) => {
                          if (categorias.includes(obs.categoria as CategoriaObservacao)) {
                            let color: "success" | "failure" | "info" | "secondary" = "info";
                            switch (grupo) {
                              case "Acadêmicas":
                                color = "info";
                                break;
                            ...
                            return (
                              <Badge key={obs.id} color={color}>
                                {obs.categoria.charAt(0) + obs.categoria.slice(1).toLowerCase().replaceAll("_", " ")}
                              </Badge>
                            );
                          }
                          return null;
