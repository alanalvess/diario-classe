...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<Map<String, Object>> tratarProfessorNaoEncontrado(ProfessorNaoEncontradoException ex) {
        return buildResponse(HttpStatus.NOT_FOUND, ex.getMessage());
    }

    @ExceptionHandler(ProfessorDuplicadoException.class)
    public ResponseEntity<Map<String, Object>> tratarProfessorDuplicado(ProfessorDuplicadoException ex) {
    ...
    public ResponseEntity<Map<String, Object>> tratarViolacaoIntegridade(DataIntegrityViolationException ex) {
        ...
        if (ex.getMostSpecificCause().getMessage().contains("tb_professores.nome")) {
