...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<Map<String, Object>> tratarAlunoNaoEncontrado(AlunoNaoEncontradoException ex) {
        return buildResponse(HttpStatus.NOT_FOUND, ex.getMessage());
    }

    @ExceptionHandler(AlunoDuplicadoException.class)
    public ResponseEntity<Map<String, Object>> tratarAlunoDuplicado(AlunoDuplicadoException ex) {
